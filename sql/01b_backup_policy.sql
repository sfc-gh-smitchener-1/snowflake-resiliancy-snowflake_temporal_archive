-- ============================================================================
-- SNOWFLAKE TEMPORAL ARCHIVE - OPTIONAL WORM BACKUP POLICY
-- ============================================================================
...
--   This policy uses WITH RETENTION LOCK + EXPIRE_AFTER_DAYS = 2555 (7 years).
...
-- 1. WORM-compliant backup policy with 7-year retention
...
CREATE BACKUP SET IF NOT EXISTS TEMPORAL_ARCHIVE_BACKUPS
