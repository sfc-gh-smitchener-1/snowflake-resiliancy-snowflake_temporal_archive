...
CREATE OR REPLACE SEMANTIC VIEW {{DATABASE_NAME}}.{{SEMANTIC_SCHEMA}}.SERVERLESS_COST_ANALYTICS
    
    TABLES (
        DYNAMIC_TABLE_REFRESH AS {{DATABASE_NAME}}.{{ACCOUNT_USAGE_SCHEMA}}.DYNAMIC_TABLE_REFRESH_HISTORY_ARCHIVE
            PRIMARY KEY (ID, REFRESH_START_TIME)
            WITH SYNONYMS ('dynamic tables', 'dt refresh', 'dynamic table runs'),
            
        SERVERLESS_TASK AS {{DATABASE_NAME}}.{{ACCOUNT_USAGE_SCHEMA}}.SERVERLESS_TASK_HISTORY_ARCHIVE
            PRIMARY KEY (TASK_ID, START_TIME)
            WITH SYNONYMS ('serverless tasks', 'task credits', 'task runs'),
            
        METERING_DAILY AS {{DATABASE_NAME}}.{{ACCOUNT_USAGE_SCHEMA}}.METERING_DAILY_HISTORY_ARCHIVE
            PRIMARY KEY (SERVICE_TYPE, USAGE_DATE)
            WITH SYNONYMS ('daily metering', 'daily credits', 'service costs'),
            
        AUTO_CLUSTERING AS {{DATABASE_NAME}}.{{ACCOUNT_USAGE_SCHEMA}}.AUTOMATIC_CLUSTERING_HISTORY_ARCHIVE
            PRIMARY KEY (TABLE_ID, START_TIME)
            WITH SYNONYMS ('clustering', 'auto cluster', 'reclustering'),
            
        PIPE_USAGE AS {{DATABASE_NAME}}.{{ACCOUNT_USAGE_SCHEMA}}.PIPE_USAGE_HISTORY_ARCHIVE
...
CREATE OR REPLACE SEMANTIC VIEW {{DATABASE_NAME}}.{{SEMANTIC_SCHEMA}}.WAREHOUSE_COST_ANALYTICS
    
    TABLES (
        WAREHOUSE_METERING AS {{DATABASE_NAME}}.{{ACCOUNT_USAGE_SCHEMA}}.WAREHOUSE_METERING_HISTORY_ARCHIVE
            PRIMARY KEY (START_TIME, WAREHOUSE_ID)
            WITH SYNONYMS ('warehouse usage', 'credit consumption', 'compute costs', 'warehouse credits'),
            
        QUERY_HISTORY AS {{DATABASE_NAME}}.{{ACCOUNT_USAGE_SCHEMA}}.QUERY_HISTORY_ARCHIVE
...
CREATE OR REPLACE SEMANTIC VIEW {{DATABASE_NAME}}.{{SEMANTIC_SCHEMA}}.SECURITY_ANALYTICS
    
    TABLES (
        LOGIN_HISTORY AS {{DATABASE_NAME}}.{{ACCOUNT_USAGE_SCHEMA}}.LOGIN_HISTORY_ARCHIVE
            PRIMARY KEY (EVENT_ID)
            WITH SYNONYMS ('logins', 'authentication events', 'sign-ins', 'access attempts'),
            
        USERS AS {{DATABASE_NAME}}.{{ACCOUNT_USAGE_SCHEMA}}.USERS_ARCHIVE
            PRIMARY KEY (USER_ID)
            UNIQUE (NAME)
...
CREATE OR REPLACE SEMANTIC VIEW {{DATABASE_NAME}}.{{SEMANTIC_SCHEMA}}.STORAGE_ANALYTICS
    
    TABLES (
        STORAGE_USAGE AS {{DATABASE_NAME}}.{{ACCOUNT_USAGE_SCHEMA}}.STORAGE_USAGE_ARCHIVE
            PRIMARY KEY (USAGE_DATE)
            WITH SYNONYMS ('storage', 'disk usage', 'data storage', 'account storage'),
            
        DATABASE_STORAGE AS {{DATABASE_NAME}}.{{ACCOUNT_USAGE_SCHEMA}}.DATABASE_STORAGE_USAGE_HISTORY_ARCHIVE
            PRIMARY KEY (USAGE_DATE, DATABASE_ID)
            WITH SYNONYMS ('database storage', 'db storage', 'database size'),
            
        TABLE_STORAGE AS {{DATABASE_NAME}}.{{ACCOUNT_USAGE_SCHEMA}}.TABLE_STORAGE_METRICS_ARCHIVE
...
CREATE OR REPLACE SEMANTIC VIEW {{DATABASE_NAME}}.{{SEMANTIC_SCHEMA}}.GOVERNANCE_ANALYTICS
    ...
    TABLES (
        ...
        ROLES AS {{DATABASE_NAME}}.{{ACCOUNT_USAGE_SCHEMA}}.ROLES_ARCHIVE
            PRIMARY KEY (ROLE_ID)
            UNIQUE (NAME)
            WITH SYNONYMS ('roles', 'security roles'),
            
        GRANTS_TO_USERS AS {{DATABASE_NAME}}.{{ACCOUNT_USAGE_SCHEMA}}.GRANTS_TO_USERS_ARCHIVE
...
CREATE OR REPLACE SEMANTIC VIEW {{DATABASE_NAME}}.{{SEMANTIC_SCHEMA}}.TASK_ANALYTICS
    
    TABLES (
        TASK_HISTORY AS {{DATABASE_NAME}}.{{ACCOUNT_USAGE_SCHEMA}}.TASK_HISTORY_ARCHIVE
            PRIMARY KEY (QUERY_ID)
...
CREATE OR REPLACE SEMANTIC VIEW {{DATABASE_NAME}}.{{SEMANTIC_SCHEMA}}.BCDR_ANALYTICS
    ...
    TABLES (
        ...
        REPLICATION_USAGE AS {{DATABASE_NAME}}.{{ACCOUNT_USAGE_SCHEMA}}.DATABASE_REPLICATION_USAGE_HISTORY_ARCHIVE
            PRIMARY KEY (DATABASE_ID, START_TIME)
            WITH SYNONYMS ('replication', 'database replication', 'sync'),
            
        -- Replication groups configuration
        REPLICATION_GROUPS AS {{DATABASE_NAME}}.{{ACCOUNT_USAGE_SCHEMA}}.REPLICATION_GROUPS_ARCHIVE
            PRIMARY KEY (NAME)
...
CREATE OR REPLACE SEMANTIC VIEW {{DATABASE_NAME}}.{{SEMANTIC_SCHEMA}}.COST_ANALYTICS
...
CREATE OR REPLACE SEMANTIC VIEW {{DATABASE_NAME}}.{{SEMANTIC_SCHEMA}}.QUERY_PERFORMANCE_ANALYTICS
    ...
    TABLES (
        ...
        ACCESS_HISTORY AS {{DATABASE_NAME}}.{{ACCOUNT_USAGE_SCHEMA}}.ACCESS_HISTORY_ARCHIVE
            PRIMARY KEY (QUERY_ID)
...
CREATE OR REPLACE SEMANTIC VIEW {{DATABASE_NAME}}.{{SEMANTIC_SCHEMA}}.ORGANIZATION_ANALYTICS
    
    TABLES (
        USAGE_CURRENCY AS {{DATABASE_NAME}}.{{ORG_SCHEMA}}.USAGE_IN_CURRENCY_DAILY_ARCHIVE
        ...
        REMAINING_BALANCE AS {{DATABASE_NAME}}.{{ORG_SCHEMA}}.REMAINING_BALANCE_DAILY_ARCHIVE
            PRIMARY KEY (CONTRACT_NUMBER, DATE)
            WITH SYNONYMS ('balance', 'remaining credits', 'contract balance', 'capacity remaining'),
            
        METERING_DAILY AS {{DATABASE_NAME}}.{{ORG_SCHEMA}}.METERING_DAILY_HISTORY_ARCHIVE
        ...
        WAREHOUSE_METERING AS {{DATABASE_NAME}}.{{ORG_SCHEMA}}.WAREHOUSE_METERING_HISTORY_ARCHIVE
        ...
        ACCOUNTS AS {{DATABASE_NAME}}.{{ORG_SCHEMA}}.ACCOUNTS_ARCHIVE
    ...
    DIMENSIONS (
        ...
        METERING_DAILY.metering_service AS METERING_DAILY.SERVICE_TYPE
            ...
            COMMENT = 'Service type: WAREHOUSE_METERING, AUTO_CLUSTERING, SERVERLESS_TASK, MATERIALIZED_VIEW, PIPE, SEARCH_OPTIMIZATION',
...
GRANT USAGE ON SCHEMA {{DATABASE_NAME}}.{{SEMANTIC_SCHEMA}} TO ROLE {{READER_ROLE}};
GRANT USAGE ON SCHEMA {{DATABASE_NAME}}.{{SEMANTIC_SCHEMA}} TO ROLE {{WRITER_ROLE}};
GRANT USAGE ON SCHEMA {{DATABASE_NAME}}.{{SEMANTIC_SCHEMA}} TO ROLE {{ARCHIVE_ADMIN_ROLE}};
...
SHOW SEMANTIC VIEWS IN SCHEMA {{DATABASE_NAME}}.{{SEMANTIC_SCHEMA}};
